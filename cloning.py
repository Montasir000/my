...
\x1b[1;96m┏─══─━══─══━─══─| ✠ |─══━─══─══━─══─┓
\x1b[38;5;46m┃AUTHOR    ; Montasir Sabit    ┃
\x1b[1;93m┃TELEGRAM  ; @Montasir00   ┃
\x1b[1;95m┃STATUS        ; FREE                  ┃
\x1b[1;91m┃GITHUB    ; Montasir000        ┃
\x1b[1;96m┗─══─━════─━─══─| ✠ |─══━─══─══━─══─┛
...
def xr():
    ...
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m Ids saved in Montasir/ok.txt,Montasir/cp.txt')
    print('\033[1;94m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r \033[1;91m[\033[1;97mMONTASIR\033[1;91m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
